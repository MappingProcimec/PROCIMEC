...
export default function AttendanceTrackerPage() {
  ...
  useEffect(() => {
    fetchHistory(filterFrom, filterTo);
  }, [filterFrom, filterTo, fetchHistory]);
  ...
  const handleDownloadPDF = () => {
    const userName = session?.user?.name || 'Colaborador PROCIMEC';
    const userRole = (session?.user as { role?: string })?.role || 'Personal Operativo';
    const periodLabel =
      filterMode === 'quincena'
  ...
  return (
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="flex flex-col sm:items-end gap-2">
              ...
              <div className="flex items-center gap-1.5 text-xs">
                {geoLocating ? (
                  ...
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-200 border border-emerald-400/40">
      ...
      <div className="max-w-6xl mx-auto px-4 -mt-6 pb-20 space-y-8">
        ...
        {/* 1. SECCIÓN DE ACCIÓN RÁPIDA (ENTRADA / SALIDA / SALIDA A CAMPO) */}
        <section className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-6 sm:p-8">
            <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100">
              <div>
                <h2 className="text-lg font-bold text-slate-900">Jornada de Hoy</h2>
            ...
            {loadingToday ? (
              ...
              <div>
                ...
                {/* CASO B: Entrada registrada, jornada activa (puede salir a campo o marcar salida definitiva) */}
                {todayRecord && !todayRecord.check_out_time && (
                  <div className="space-y-6">
                    {/* Tarjeta de estado en curso */}
        ...
        {/* 2. MODAL PARA REGISTRO DE SALIDA A CAMPO / OBRA */}
        {fieldModalOpen && (
        ...
        {/* 3. SECCIÓN HISTORIAL Y DESCARGA DE NOVEDADES (PDF) */}
        <section className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden p-6 sm:p-8 space-y-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-100">
            <div>
              <h2 className="text-lg font-bold text-slate-900">Historial de Novedades y Asistencias</h2>
              <p className="text-xs text-slate-500">
                Consulta los días laborados, ubicaciones verificadas y exporta tu reporte en PDF para nómina o control interno.
              </p>
            </div>
          ...
          {/* Selector de Filtros (Quincena / Mes / Personalizado) */}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200">
              <span className="text-[11px] font-semibold text-slate-400 block uppercase">Días Asistidos</span>
