  ...
  return (
    <main className="min-h-screen bg-procimec-gradient flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm animate-slide-up">
        {/* Navigation link to public home */}
        <div className="mb-6 flex justify-start">
          <Link href="/" className="inline-flex items-center gap-2 text-white/70 hover:text-white text-xs font-medium transition-colors">
        ...
        <div className="flex justify-center gap-4 text-white/50 text-xs mt-6">
          <Link href="/privacy" className="hover:text-white underline transition-colors">
            Política de Privacidad
          </Link>
          <span>·</span>
          <Link href="/terms" className="hover:text-white underline transition-colors">
