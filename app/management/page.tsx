  ...
  return (
    <div className="min-h-[100dvh] bg-surface flex flex-col">
      ...
      <div className="page-hero">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <span className="badge bg-slate-500/20 text-slate-300 border border-slate-500/40 text-xs font-mono font-medium tracking-wide uppercase px-2.5 py-1">
            ...
            <span className="badge bg-white/10 text-white/90 border border-white/20 text-xs font-mono font-semibold px-2.5 py-1 flex items-center gap-1.5">
              <Building className="w-3.5 h-3.5 text-accent" strokeWidth={1.75} />
              Rol: Gerencia
            </span>
          </div>
          ...
          <p className="text-white/75 text-sm sm:text-base mt-2 max-w-2xl leading-relaxed">
            Tableros ejecutivos de control integral, indicadores clave de rendimiento (KPIs), avance de obra y toma estratégica de decisiones.
          </p>
        </div>
      </div>
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 -mt-6 pb-16 w-full space-y-6">
        {/* Pilot Phase Banner */}
        <div className="card border border-slate-300 bg-slate-100/70 p-5 rounded-2xl shadow-sm">
          <div className="flex items-start gap-3.5">
            <div className="w-10 h-10 rounded-xl bg-slate-900/10 border border-slate-900/20 flex items-center justify-center text-slate-800 flex-shrink-0 mt-0.5">
              <ShieldCheck className="w-5 h-5 text-slate-700" strokeWidth={1.75} />
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <span className="inline-flex items-center gap-1.5 text-xs font-mono font-semibold px-2 py-0.5 rounded-full bg-slate-200 text-slate-900 border border-slate-300">
                  <CheckCircle2 className="w-3.5 h-3.5 text-slate-700" strokeWidth={1.75} />
                  Rol Activo
                </span>
              </div>
              <p className="text-xs sm:text-sm text-slate-800 mt-1 leading-relaxed">
                Este rol base ha sido verificado con éxito en la plataforma PROCIMEC. Su perfil de usuario tiene asignada la identidad canónica de <strong className="font-semibold text-slate-950">Gerencia</strong>. Los tableros consolidados y reportes ejecutivos se desplegarán según el plan progresivo.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="card border border-border p-5 rounded-2xl shadow-xs space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-sm font-bold text-text-primary truncate">
                  {user?.fullName || 'Dirección General'}
                </h3>
            ...
            <div className="pt-2 border-t border-border/60 space-y-2 text-xs">
              ...
              <div className="flex justify-between items-center py-1">
                ...
                <span className="font-semibold text-slate-900 bg-slate-100 border border-slate-300 px-2 py-0.5 rounded">
                  Gerencia
                </span>
              </div>
              <div className="flex justify-between items-center py-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
              <div className="border border-border/80 bg-gray-50/50 rounded-xl p-3.5 space-y-1.5">
                <div className="flex items-center gap-2 text-xs font-bold text-text-primary">
                  ...
                  <span>Tablero Maestro de Rentabilidad</span>
                </div>
                <p className="text-xs text-text-muted leading-relaxed">
                  Consolidado de costos operativos vs facturación de proyectos de geofísica y topografía.
                </p>
                <div className="pt-1">
                  <span className="text-[10px] font-mono font-medium text-slate-700 bg-slate-200 px-2 py-0.5 rounded">
                    Capa 4: Herramienta
                  </span>
                </div>
              </div>
              ...
              <div className="border border-border/80 bg-gray-50/50 rounded-xl p-3.5 space-y-1.5">
                <div className="flex items-center gap-2 text-xs font-bold text-text-primary">
                  <ShieldAlert className="w-4 h-4 text-primary" strokeWidth={1.75} />
                  <span>Alertas y Aprobaciones Ejecutivas</span>
                </div>
                <p className="text-xs text-text-muted leading-relaxed">
                  Visto bueno de compras extraordinarias, adiciones presupuestales y firma de actas de entrega.
                </p>
                <div className="pt-1">
                  <span className="text-[10px] font-mono font-medium text-slate-700 bg-slate-200 px-2 py-0.5 rounded">
                    Capa 6: Formularios
