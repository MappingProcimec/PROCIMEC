...
export default function ElaboracionCartasPage() {
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 sm:p-6">
              <div className="flex items-center justify-between gap-4 border-b border-slate-100 pb-4 mb-5">
                ...
                <Link
                  href="/admin/forms"
                  className="text-xs font-semibold text-slate-600 hover:text-[#1E2229] flex items-center gap-1.5 transition-colors"
                >
                  <Eye className="w-4 h-4 text-[#EAA023]" strokeWidth={1.75} />
                  Ver Auditoría
                </Link>
              </div>
