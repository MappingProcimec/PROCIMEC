...
function WarehouseOperationsContent() {
  ...
  // Mode Selection (Despacho, Retorno, Alta, Consumibles)
  const initialMode = (searchParams.get('mode') as WarehouseOperationMode) || 'despacho';
    ...
    <div className="min-h-[100dvh] bg-surface flex flex-col">
      ...
      <div className="bg-primary text-white border-b border-border shadow-xs">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          {/* Navegación por Pestañas de Modos de Operación */}
          <div className="flex flex-wrap items-center gap-2 mt-6 pt-4 border-t border-white/10">
            ...
            <Link
              href="/tools/warehouse-inventory"
              className="ml-auto text-xs text-white/80 hover:text-white flex items-center gap-1.5 py-2 px-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 transition-colors"
            >
              <span>Ver Kárdex e Inventario</span>
          ...
          <div className="card p-5 mb-6 bg-emerald-50 border border-emerald-200 text-emerald-900 rounded-2xl flex items-start gap-3 shadow-xs">
            ...
            <div className="flex-1 text-sm">
              ...
              <div className="flex items-center gap-3 mt-3">
                ...
                >
                  Ver en el Kárdex de Bodega <ArrowRight className="w-3.5 h-3.5" />
                </Link>
              </div>
            </div>
          </div>
