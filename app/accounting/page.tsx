  ...
  return (
    <div className="min-h-[100dvh] bg-surface flex flex-col">
      ...
      <div className="page-hero">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <span className="badge bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 text-xs font-mono font-medium tracking-wide uppercase px-2.5 py-1">
              División Contable
            </span>
            <span className="badge bg-white/10 text-white/90 border border-white/20 text-xs font-mono font-semibold px-2.5 py-1 flex items-center gap-1.5">
              <Receipt className="w-3.5 h-3.5 text-accent" strokeWidth={1.75} />
              Rol: Contabilidad
            </span>
          </div>
          ...
          <p className="text-white/75 text-sm sm:text-base mt-2 max-w-2xl leading-relaxed">
            Emisión de facturas electrónicas, control de cartera de clientes de ingeniería y legalización de anticipos y gastos de campo.
          </p>
        </div>
      </div>
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 -mt-6 pb-16 w-full space-y-6">
        {/* Pilot Phase Banner */}
        <div className="card border border-cyan-200 bg-cyan-50/70 p-5 rounded-2xl shadow-sm">
          <div className="flex items-start gap-3.5">
            <div className="w-10 h-10 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-700 flex-shrink-0 mt-0.5">
              <ShieldCheck className="w-5 h-5 text-cyan-600" strokeWidth={1.75} />
            </div>
            <div className="flex-1 min-w-0">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <h2 className="text-base font-bold text-cyan-950">
                  Capa 2: Rol Base Habilitado
                </h2>
                <span className="inline-flex items-center gap-1.5 text-xs font-mono font-semibold px-2 py-0.5 rounded-full bg-cyan-200/80 text-cyan-900 border border-cyan-300">
                  <CheckCircle2 className="w-3.5 h-3.5 text-cyan-700" strokeWidth={1.75} />
                  Rol Activo
                </span>
              </div>
              <p className="text-xs sm:text-sm text-cyan-900/80 mt-1 leading-relaxed">
                Este rol base ha sido verificado con éxito en la plataforma PROCIMEC. Su perfil de usuario tiene asignada la identidad canónica de <strong className="font-semibold text-cyan-950">Contabilidad</strong>. El control de facturación y legalización de viáticos se desplegarán según el plan progresivo.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="card border border-border p-5 rounded-2xl shadow-xs space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-sm font-bold text-text-primary truncate">
                  {user?.fullName || 'Responsable de Contabilidad'}
                </h3>
            ...
            <div className="pt-2 border-t border-border/60 space-y-2 text-xs">
              ...
              <div className="flex justify-between items-center py-1">
                ...
                <span className="font-semibold text-cyan-900 bg-cyan-50 border border-cyan-200 px-2 py-0.5 rounded">
                  Contabilidad
                </span>
              </div>
              <div className="flex justify-between items-center py-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
              <div className="border border-border/80 bg-gray-50/50 rounded-xl p-3.5 space-y-1.5">
                <div className="flex items-center gap-2 text-xs font-bold text-text-primary">
                  ...
                  <span>Control de Facturas y Cartera</span>
                </div>
                <p className="text-xs text-text-muted leading-relaxed">
                  Monitoreo de facturación radicada vs metros lineales validados en campo por los localizadores.
                </p>
                <div className="pt-1">
                  <span className="text-[10px] font-mono font-medium text-cyan-700 bg-cyan-100/70 px-2 py-0.5 rounded">
                    Capa 4: Herramienta
                  </span>
                </div>
              </div>
              ...
              <div className="border border-border/80 bg-gray-50/50 rounded-xl p-3.5 space-y-1.5">
                <div className="flex items-center gap-2 text-xs font-bold text-text-primary">
                  ...
                  <span>Legalización de Gastos de Campo</span>
                </div>
                <p className="text-xs text-text-muted leading-relaxed">
                  Registro digital de recibos, combustible y viáticos con validación por centro de costo.
                </p>
                <div className="pt-1">
                  <span className="text-[10px] font-mono font-medium text-cyan-700 bg-cyan-100/70 px-2 py-0.5 rounded">
                    Capa 6: Formularios
